// src/components/laporanKeuangan/FinancialMobileCards.js
...
import {
  ...
  Typography,
  Box,
  AccountBalance as AccountBalanceIcon // Make sure this import is correct
} from '@mui/icons-material' // Note: Icons come from @mui/icons-material, not @mui/material
import { formatDateTime, formatRupiah } from './utils'

export const FinancialMobileCards = ({ filteredData }) => {
  return (
